...
public class EnemyShooting : MonoBehaviour {
	...
	private SphereCollider col;							// Reference to the sphere collider.							// Reference to the player's transform.

/// </summary>private DonePlayerHealth playerHealth;				// Reference to the player's health.//
